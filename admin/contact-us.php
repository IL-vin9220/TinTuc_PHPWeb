...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($_REQUEST["address"])){
            $address_err =  "<p style='color:red'> * 
Địa chỉ là bắt buộc </p>";
            $address = "";
        }else{
        ...
        if( empty($_REQUEST["phn"]) ){
            ...
            $phn_no_err = "<p style='color:red'> * Chỉ cho phép số</p>";
        ...
        if( empty($_REQUEST["email"])){
            $email_err = "<p style='color:red'> * Email là cần thiết </p>";
            $email = "";
        ...
        if( empty($_REQUEST["fax"]) ){
            $fax_err = "<p style='color:red'> * 
Số fax là bắt buộc </p>";
            $fax = "";
        }elseif(preg_match('/[a-zA-Z]/', $_REQUEST["fax"] ) ){ 
            $fax_err = "<p style='color:red'> * Chỉ cho phép số</p>";
        ...
        if(!empty($email) && !empty($address) && !empty($phn_no) && !empty($fax)){
            ...
            if($result){
                ...
                $(document).ready( function(){
                    ...
                    $('#linkBtn').hide();
                    $('#addMsg').text('Đã cập nhật thành công chi tiết liên hệ!');
                    $('#closeBtn').text('OK');
                })
             </script>
             ";
